...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    try {
      ...
      // read() 메소드
      // 1. 1개 데이터를 읽는다.
      // 2. 읽은 내용이 없으면 -1를 반환한다.
      
      // 반복문 : 읽은 내용이 -1이 아니면 계속 읽는다.
      while ( (c = fin.read()) != -1) {
        sb.append((char)c); // 시작부터 char 불가능하게 입력단위에 존재하지않는다.
      }
      // 아스키 코드값 저장 A int 65로 저장  
  ...
  public static void ex02() {
    ...
    try {
      ...
      // 2. 실제로 읽은 바아ㅣ트 수를 반환한다.
      // 3. 읽은 내용이 없으면 -1를 반환한다.
  ...
  public static void ex03() {
     ...
     *  2. 많은 데이터를 한 번에 입력받기 떄문에 속도 향상을 위해서 사용한다.
  ...
  public static void ex04() {
    ...
    // Data OutputStream과 DataInputStream을 사용하면
