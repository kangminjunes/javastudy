...
public class MainWrapper {
  ...
  public static void ex02()  {
    ...
    if(file.exists()) {
      ...
      file.createNewFile(); // 반드시 예외 처리르 해야 하는 코드(check)
  ...
  public static void ex03() {
    ...
    for(int i = 0; i < files.length; i++) {
      ...
      sb.append(String.format("%-20s",kind));
  ...
  public static void main(String[] args) {
    System.out.println("예시 1번실행결과");
    ex01();
    System.out.println("예시 2번실행결과");
    ex02();
    System.out.println("예시 3번실행결과");
    ex03();
  }
